...
class template_bug456_class : public unit_fixture
{
private:
...
public:
  ...
  EXAMPLE_TEST_FIXTURE(template_bug456_class)
  {
    TEST_CASE(template_bug456_method);
  }
   ...
   */
  void template_bug456_method();

};

REGISTER_FIXTURE(template_bug456_class);
} /* namespace regression */
} /* namespace testsuite */
